export default function InfoNegocio() {
    ...
    return (
        <div style={{
            ...
            lineHeight: 1.6
        }} translate="no">   {/* 👈 evita traducción en todo el bloque */}
            ...
            <div style={{
                ...
                {/* PRECIOS */}
                <h2 style={{ marginTop: 20, marginBottom: 10 }}>💰 Precios de juegos <span translate="no">offline</span></h2>
                <table style={{
                    width: '100%',
                    ...
                    <tbody>
                        <tr><td style={{ padding: '6px' }}>0 Gb – 1 Gb</td><td><span translate="no">100 CUP</span></td></tr>
                        <tr><td style={{ padding: '6px' }}>1 Gb – 10 Gb</td><td><span translate="no">200 CUP</span></td></tr>
                        <tr><td style={{ padding: '6px' }}>10 Gb – 30 Gb</td><td><span translate="no">400 CUP</span></td></tr>
                        <tr><td style={{ padding: '6px' }}>30 Gb – 60 Gb</td><td><span translate="no">600 CUP</span></td></tr>
                        <tr><td style={{ padding: '6px' }}>60 Gb – 80 Gb</td><td><span translate="no">800 CUP</span></td></tr>
                        <tr><td style={{ padding: '6px' }}>Más de 80 Gb</td><td><span translate="no">1000 CUP</span></td></tr>
                    </tbody>
                </table>
                <p style={{ fontSize: '0.95em', color: '#ccc' }}>
                    🎮 Todos los juegos <em translate="no">online</em> cuestan <span translate="no">1000 CUP</span> y siempre se entregan actualizados.
                </p>

                {/* OFERTAS */}
                <h2 style={{ marginTop: 20, marginBottom: 10 }}>💿 Ofertas llenado de <span translate="no">discos duros</span></h2>
                <div style={{
                    display: 'grid',
                ...
                <p style={{ fontSize: '0.95em', color: '#ccc' }}>
                    ...
                    <span translate="no"> 1000 CUP</span> dependiendo de la lejanía.<br />
